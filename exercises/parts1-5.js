...
// console.log(`${spaceShuttle.name} will take ${spaceShuttle.printDaysToLocation(new SpaceLocation('Mars', kilometersToMars))} days to get to Mars.`);
spaceShuttle.printDaysToLocation(new SpaceLocation_1.SpaceLocation('Mars', kilometersToMars));
// console.log(`${spaceShuttle.name} will take ${spaceShuttle.printDaysToLocation(new SpaceLocation('Mars', kilometersToTheMoon))} days to get to the Moon.`);
